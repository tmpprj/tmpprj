...
void OutputDev::drawImageMask(GfxState *state, Object *ref, Stream *str,
                              ...
                              GBool inlineImg) {
    boost::ignore_unused_variable_warning( ref );
    boost::ignore_unused_variable_warning( invert );
    boost::ignore_unused_variable_warning( state );
    int i, j;
...
void OutputDev::drawImage(GfxState *state, Object *ref, Stream *str,
    ...
    boost::ignore_unused_variable_warning( maskColors );
    int i, j;
...
void OutputDev::drawMaskedImage(GfxState *state, Object *ref, Stream *str,
                                ...
                                GBool maskInvert) {
    boost::ignore_unused_variable_warning( maskStr );
    boost::ignore_unused_variable_warning( maskWidth );
    boost::ignore_unused_variable_warning( maskHeight );
    boost::ignore_unused_variable_warning( maskInvert );
...
void OutputDev::drawSoftMaskedImage(GfxState *state, Object *ref, Stream *str,
    ...
    boost::ignore_unused_variable_warning( maskWidth );
    boost::ignore_unused_variable_warning( maskHeight );
    boost::ignore_unused_variable_warning( maskColorMap );
    drawImage(state, ref, str, width, height, colorMap, NULL, gFalse);
}
