...
GString *Stream::getPSFilter(int psLevel, char *indent) {
    boost::ignore_unused_variable_warning( psLevel );
    boost::ignore_unused_variable_warning( indent );
...
Stream *EmbedStream::makeSubStream(Guint start, GBool limitedA,
				   Guint lengthA, Object *dictA) {
    boost::ignore_unused_variable_warning( start );boost::ignore_unused_variable_warning( limitedA );boost::ignore_unused_variable_warning( lengthA );boost::ignore_unused_variable_warning( dictA );
...
void EmbedStream::setPos(Guint pos, int dir) {
    boost::ignore_unused_variable_warning( pos );boost::ignore_unused_variable_warning( dir );
...
void EmbedStream::moveStart(int delta) {
    boost::ignore_unused_variable_warning( delta );
...
GBool RunLengthStream::isBinary(GBool last) {boost::ignore_unused_variable_warning( last );
  return str->isBinary(gTrue);
}
...
GBool CCITTFaxStream::isBinary(GBool last) {boost::ignore_unused_variable_warning( last );
  return str->isBinary(gTrue);
}
...
GBool DCTStream::isBinary(GBool last) {boost::ignore_unused_variable_warning( last );
  return str->isBinary(gTrue);
}
...
GBool FlateStream::isBinary(GBool last) {boost::ignore_unused_variable_warning( last );
  return str->isBinary(gTrue);
}
...
GBool FixedLengthEncoder::isBinary(GBool last) {boost::ignore_unused_variable_warning( last );
  return str->isBinary(gTrue);
}
