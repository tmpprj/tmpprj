...
Stream *EmbedStream::makeSubStream(Guint start, GBool limitedA,
                                   Guint lengthA, Object *dictA) {
    boost::ignore_unused_variable_warning( start );
    boost::ignore_unused_variable_warning( limitedA );
    boost::ignore_unused_variable_warning( lengthA );
    boost::ignore_unused_variable_warning( dictA );
