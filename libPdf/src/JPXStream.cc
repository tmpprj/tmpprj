...
GString *JPXStream::getPSFilter(int psLevel, char *indent) {boost::ignore_unused_variable_warning( psLevel );boost::ignore_unused_variable_warning( indent );
  return NULL;
}

GBool JPXStream::isBinary(GBool last) {boost::ignore_unused_variable_warning( last );
...
GBool JPXStream::readCodestream(Guint len) {boost::ignore_unused_variable_warning( len );
  JPXTile *tile;
  JPXTileComp *tileComp;
  int segType;
...
GBool JPXStream::readCodeBlockData(JPXTileComp *tileComp,
				   ...
				   JPXSubband *subband,
				   Guint res, Guint sb,
                   JPXCodeBlock *cb) {boost::ignore_unused_variable_warning( resLevel );boost::ignore_unused_variable_warning( precinct );boost::ignore_unused_variable_warning( subband );
