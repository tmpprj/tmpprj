...
GBool TextFlow::blockFits(TextBlock *blk, TextBlock *prevBlk) {
    boost::ignore_unused_variable_warning( prevBlk );
  GBool fits;
...
void TextPage::coalesce(GBool physLayout, GBool doHTML) {
    boost::ignore_unused_variable_warning( physLayout );
  UnicodeMap *uMap;
  TextPool *pool;
...
void TextOutputDev::endPage() {
  ...
  if (outputStream) {
    text->dump(outputStream, outputFunc, physLayout, writer_func);
  }
}
...
void TextOutputDev::beginString(GfxState *state, GString *s) {
    boost::ignore_unused_variable_warning( state );boost::ignore_unused_variable_warning( s );
}

void TextOutputDev::endString(GfxState *state) {boost::ignore_unused_variable_warning( state );
}
...
void TextOutputDev::drawChar(GfxState *state, double x, double y,
			     ...
			     CharCode c, int nBytes, Unicode *u, int uLen) {
    boost::ignore_unused_variable_warning( state );boost::ignore_unused_variable_warning( originX );boost::ignore_unused_variable_warning( originY );
