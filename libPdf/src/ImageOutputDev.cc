...
void ImageOutputDev::drawImageMask(GfxState *state, Object *ref, Stream *str,
                   ...
                   GBool inlineImg) {boost::ignore_unused_variable_warning( state );boost::ignore_unused_variable_warning( ref );boost::ignore_unused_variable_warning( invert );
  FILE *f;
  int c;
  int size, i;
...
void ImageOutputDev::drawImage(GfxState *state, Object *ref, Stream *str,
                   ...
                   int *maskColors, GBool inlineImg) {boost::ignore_unused_variable_warning( state );boost::ignore_unused_variable_warning( ref );boost::ignore_unused_variable_warning( state );boost::ignore_unused_variable_warning( ref );boost::ignore_unused_variable_warning( maskColors );
  FILE *f;
  ImageStream *imgStr;
  Guchar *p;
  GfxRGB rgb;
