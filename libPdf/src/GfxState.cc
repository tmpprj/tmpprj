...
void GfxColorSpace::getDefaultRanges(double *decodeLow, double *decodeRange,
                     int maxImgPixel) {boost::ignore_unused_variable_warning( maxImgPixel );
  int i;
...
void GfxPatternColorSpace::getGray(GfxColor *color, GfxGray *gray) {boost::ignore_unused_variable_warning( color );
  *gray = 0;
}

void GfxPatternColorSpace::getRGB(GfxColor *color, GfxRGB *rgb) {boost::ignore_unused_variable_warning( color );
  rgb->r = rgb->g = rgb->b = 0;
}

void GfxPatternColorSpace::getCMYK(GfxColor *color, GfxCMYK *cmyk) {boost::ignore_unused_variable_warning( color );
  cmyk->c = cmyk->m = cmyk->y = 0;
  cmyk->k = 1;
}

void GfxPatternColorSpace::getDefaultColor(GfxColor *color) {boost::ignore_unused_variable_warning( color );
  // not used
}
