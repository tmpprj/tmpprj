...
ExponentialFunction::ExponentialFunction(Object *funcObj, Dict *dict) {boost::ignore_unused_variable_warning( funcObj );
  Object obj1, obj2;
  int i;
...
StitchingFunction::StitchingFunction(Object *funcObj, Dict *dict) {boost::ignore_unused_variable_warning( funcObj );
  Object obj1, obj2;
  int i;
