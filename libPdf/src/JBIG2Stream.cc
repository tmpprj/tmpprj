...
struct JBIG2BitmapPtr {
    JBIG2BitmapPtr():p(NULL),shift(0),x(0){}
...
GString *JBIG2Stream::getPSFilter(int psLevel, char *indent) {boost::ignore_unused_variable_warning( psLevel );boost::ignore_unused_variable_warning( indent );
  return NULL;
}

GBool JBIG2Stream::isBinary(GBool last) {boost::ignore_unused_variable_warning( last );
...
GBool JBIG2Stream::readSymbolDictSeg(Guint segNum, Guint length,
                     Guint *refSegs, Guint nRefSegs) {boost::ignore_unused_variable_warning( length );
...
void JBIG2Stream::readTextRegionSeg(Guint segNum, GBool imm,
                    ...
                    Guint *refSegs, Guint nRefSegs) {boost::ignore_unused_variable_warning( lossless );boost::ignore_unused_variable_warning( length );
  JBIG2Bitmap *bitmap;
...
void JBIG2Stream::readGenericRegionSeg(Guint segNum, GBool imm,
                       GBool lossless, Guint length) {boost::ignore_unused_variable_warning( lossless );
  JBIG2Bitmap *bitmap;
  Guint w, h, x, y, segInfoFlags, extCombOp;
...
void JBIG2Stream::readGenericRefinementRegionSeg(Guint segNum, GBool imm,
						 GBool lossless, Guint length,
						 Guint *refSegs,
                         Guint nRefSegs) {boost::ignore_unused_variable_warning( lossless );boost::ignore_unused_variable_warning( length );
...
void JBIG2Stream::readPageInfoSeg(Guint length) {boost::ignore_unused_variable_warning( length );
...
void JBIG2Stream::readCodeTableSeg(Guint segNum, Guint length) {boost::ignore_unused_variable_warning( length );
